...
<hr>
<dt>
    <h4 class="name" id="getNewInstance"><span class="type-signature"></span>getNewInstance()</h4>
...
<hr>
<dt>
    <h4 class="name" id="getStreamObject"><span class="type-signature"></span>getStreamObject(metadataHash, writeStream [, subpath])</h4>
...
<dl class="details">
    ...
    <pre class="sunlight-highlight-javascript">// Piping object to the filesystem..
...
blobClient.getStreamObject(metadataHash, writeStream);</pre>
