  ...
  <head>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">webgme_bindings.pluginbase</a></li> 
      </ul>
    </div>  
...
<span class="kn">from</span> <span class="nn">.webgme</span> <span class="kn">import</span> <span class="n">WebGME</span>
<span class="kn">from</span> <span class="nn">.exceptions</span> <span class="kn">import</span> <span class="n">JSError</span><span class="p">,</span> <span class="n">CoreIllegalArgumentError</span><span class="p">,</span> <span class="n">CoreIllegalOperationError</span><span class="p">,</span> <span class="n">CoreInternalError</span>
...
<span class="sd">        :param files: Keys are file names and values the content (as strings or bytes).</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">extendedDict</span> <span class="o">=</span> <span class="p">{}</span>
        <span class="k">for</span> <span class="n">key</span> <span class="ow">in</span> <span class="n">files</span><span class="p">:</span>
            <span class="n">content</span> <span class="o">=</span> <span class="n">files</span><span class="p">[</span><span class="n">key</span><span class="p">];</span>
            ...
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">content</span><span class="p">,</span> <span class="nb">bytes</span><span class="p">):</span>
                <span class="n">content</span> <span class="o">=</span> <span class="n">base64</span><span class="o">.</span><span class="n">b64encode</span><span class="p">(</span><span class="n">content</span><span class="p">)</span><span class="o">.</span><span class="n">decode</span><span class="p">(</span><span class="s2">&quot;UTF-8&quot;</span><span class="p">)</span>
                <span class="n">is_bytes</span> <span class="o">=</span> <span class="kc">True</span>
            <span class="n">extendedDict</span><span class="p">[</span><span class="n">key</span><span class="p">]</span> <span class="o">=</span> <span class="p">{</span><span class="n">content</span><span class="p">:</span> <span class="n">content</span><span class="p">,</span> <span class="nb">bytes</span><span class="p">:</span> <span class="n">is_bytes</span><span class="p">}</span>

        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;addArtifact&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:</span> <span class="p">[</span><span class="n">name</span><span class="p">,</span> <span class="n">extendedDict</span><span class="p">]})</span></div>
...
<span class="sd">        :type content: Union[str, bytes]</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">else</span><span class="p">:</span>
            <span class="n">is_bytes</span> <span class="o">=</span> <span class="kc">False</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;addFile&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:</span> <span class="p">[</span><span class="n">name</span><span class="p">,</span> <span class="n">content</span><span class="p">,</span> <span class="n">is_bytes</span><span class="p">]})</span></div>
...
<div class="viewcode-block" id="PluginBase.get_bin_file"><a class="viewcode-back" href="../../_static/pluginbase.html#webgme_bindings.pluginbase.PluginBase.get_bin_file">[docs]</a>    <span class="k">def</span> <span class="nf">get_bin_file</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">metadata_hash</span><span class="p">,</span> <span class="n">sub_path</span> <span class="o">=</span> <span class="kc">None</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Retrieves the file from blob storage.</span>

<span class="sd">        :param metadata_hash: the &quot;id&quot; of the file to retrieve.</span>
<span class="sd">        :type metadata_hash: str</span>
<span class="sd">        :param sub_path: the path of the file to retrieve if it is inside an artifact/complex blob.</span>
<span class="sd">        :type sub_path: str</span>
<span class="sd">        :returns: The file content.</span>
<span class="sd">        :rtype: bytes</span>
<span class="sd">        :raises JSError: The result of the execution.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">content_as_string</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;getBinFile&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:</span> <span class="p">[</span><span class="n">metadata_hash</span><span class="p">,</span> <span class="n">sub_path</span><span class="p">]})</span>
        <span class="k">return</span> <span class="n">base64</span><span class="o">.</span><span class="n">decodebytes</span><span class="p">(</span><span class="n">content_as_string</span><span class="o">.</span><span class="n">decode</span><span class="p">(</span><span class="s1">&#39;UTF-8&#39;</span><span class="p">))</span></div>
...
<span class="sd">        :raises JSError: The result of the execution.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;sendNotification&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:</span> <span class="p">[</span><span class="n">message</span><span class="p">]})</span></div>

<div class="viewcode-block" id="PluginBase.result_set_success"><a class="viewcode-back" href="../../_static/pluginbase.html#webgme_bindings.pluginbase.PluginBase.result_set_success">[docs]</a>    <span class="k">def</span> <span class="nf">result_set_success</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">success</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Sets the the result value of the execution of the plugin. In python, if the plugin exits with 0,\</span>
<span class="sd">        the value will be true.</span>
<span class="sd">        </span>
<span class="sd">        :param success: The value to be set for the success of the plugin.</span>
<span class="sd">        :type success: bool</span>
<span class="sd">        :returns: Nothing is returned by the function.</span>
<span class="sd">        :rtype: None</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span><span class="s1">&#39;resultSetSuccess&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:[</span><span class="n">success</span><span class="p">]})</span></div>

<div class="viewcode-block" id="PluginBase.result_set_error"><a class="viewcode-back" href="../../_static/pluginbase.html#webgme_bindings.pluginbase.PluginBase.result_set_error">[docs]</a>    <span class="k">def</span> <span class="nf">result_set_error</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">message</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Sets the error reason for the failure of the plugin. Should be used together with result_set_success\</span>
<span class="sd">        as in case of successfull execution, this message is ignored. Also, only the first message will be visible\</span>
<span class="sd">        for the user.</span>
<span class="sd">        </span>
<span class="sd">        :param message: Textual description of the cause of the failure.</span>
<span class="sd">        :type message: str</span>
<span class="sd">        :returns: Nothing is returned by the function.</span>
<span class="sd">        :rtype: None</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_send</span><span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span><span class="s1">&#39;resultSetError&#39;</span><span class="p">,</span> <span class="s1">&#39;args&#39;</span><span class="p">:[</span><span class="n">message</span><span class="p">]})</span></div></div>
</pre></div>
