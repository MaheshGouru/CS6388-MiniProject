  ...
  <head>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">webgme_bindings.webgme</a></li> 
      </ul>
    </div>  
...
<span class="kn">from</span> <span class="nn">.core</span> <span class="kn">import</span> <span class="n">Core</span>
...
<span class="kn">from</span> <span class="nn">.exceptions</span> <span class="kn">import</span> <span class="n">CoreIllegalArgumentError</span><span class="p">,</span> <span class="n">CoreIllegalOperationError</span><span class="p">,</span> <span class="n">CoreInternalError</span><span class="p">,</span> <span class="n">JSError</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">port</span><span class="o">=</span><span class="mi">5555</span><span class="p">,</span> <span class="n">logger</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">address</span><span class="o">=</span><span class="kc">None</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">else</span><span class="p">:</span>
            ...
            <span class="bp">self</span><span class="o">.</span><span class="n">logger</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span><span class="s1">&#39;No logger passed to WebGME - created console logger at DEBUG level.&#39;</span><span class="p">)</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">logger</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span><span class="s1">&#39;Pass a configured logger to the constructor to suppress DEBUG messages.&#39;</span><span class="p">)</span>
...
<div class="viewcode-block" id="WebGME.handle_response"><a class="viewcode-back" href="../../_static/webgme.html#webgme_bindings.webgme.WebGME.handle_response">[docs]</a>    <span class="k">def</span> <span class="nf">handle_response</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">if</span> <span class="n">is_python_3</span><span class="p">:</span>
            <span class="n">raw_res</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_socket</span><span class="o">.</span><span class="n">recv_string</span><span class="p">()</span>
        <span class="k">else</span><span class="p">:</span>
        ...
        <span class="k">if</span> <span class="n">res</span><span class="p">[</span><span class="s1">&#39;err&#39;</span><span class="p">]:</span>
            ...
            <span class="k">else</span><span class="p">:</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">logger</span><span class="o">.</span><span class="n">error</span><span class="p">(</span><span class="n">res</span><span class="p">[</span><span class="s1">&#39;err&#39;</span><span class="p">])</span>
