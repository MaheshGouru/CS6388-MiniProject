  ...
  <head>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">webgme_bindings.util</a></li> 
      </ul>
    </div>  
...
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="n">node1</span><span class="p">[</span><span class="s1">&#39;nodePath&#39;</span><span class="p">]</span> <span class="o">==</span> <span class="n">node2</span><span class="p">[</span><span class="s1">&#39;nodePath&#39;</span><span class="p">]</span> <span class="ow">and</span> <span class="n">node1</span><span class="p">[</span><span class="s1">&#39;rootId&#39;</span><span class="p">]</span> <span class="o">==</span> <span class="n">node2</span><span class="p">[</span><span class="s1">&#39;rootId&#39;</span><span class="p">]</span></div>

<div class="viewcode-block" id="Util.traverse"><a class="viewcode-back" href="../../_static/util.html#webgme_bindings.util.Util.traverse">[docs]</a>    <span class="k">def</span> <span class="nf">traverse</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">node</span><span class="p">,</span> <span class="n">visitor_fn</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Traverses the sub-tree starting from node and invokes visitor_fn with each encountered node (including</span>
<span class="sd">        the passed in node).</span>

<span class="sd">        :param node: The root-node of the subtree to traverse.</span>
<span class="sd">        :type node: dict</span>
<span class="sd">        :param visitor_fn: The function invoked at each encountered node.</span>
<span class="sd">        :type visitor_fn: function</span>
<span class="sd">        :returns: Nothing is returned by the function.</span>
<span class="sd">        :rtype: None</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="n">core</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_webgme</span><span class="o">.</span><span class="n">core</span>

        <span class="k">def</span> <span class="nf">traverse_rec</span><span class="p">(</span><span class="n">sub_root_node</span><span class="p">):</span>
            <span class="n">visitor_fn</span><span class="p">(</span><span class="n">sub_root_node</span><span class="p">)</span>
            <span class="k">for</span> <span class="n">child</span> <span class="ow">in</span> <span class="n">core</span><span class="o">.</span><span class="n">load_children</span><span class="p">(</span><span class="n">sub_root_node</span><span class="p">):</span>
                <span class="n">traverse_rec</span><span class="p">(</span><span class="n">child</span><span class="p">)</span>

        <span class="n">traverse_rec</span><span class="p">(</span><span class="n">node</span><span class="p">)</span></div></div>
</pre></div>
